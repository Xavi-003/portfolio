...
const AIChat: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: "System Online. I'm ready to answer questions about Alex's experience, stack, or availability.", timestamp: Date.now() }
  ]);
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 bg-black/20">
            {messages.map((msg, idx) => (
                ...
                >
                    ...
                    <div className={`p-5 rounded-3xl max-w-[80%] text-sm leading-relaxed shadow-lg ${
                        msg.role === 'user' 
