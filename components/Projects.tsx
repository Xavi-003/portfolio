        ...
        {selectedId && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-8">
            ...
            <motion.div
              ...
              className="w-full max-w-6xl bg-[#0f0518] rounded-[2rem] overflow-hidden border border-neon-violet/30 relative shadow-[0_0_100px_-20px_rgba(124,58,237,0.6)] flex flex-col lg:flex-row max-h-[90vh] z-50 ring-1 ring-white/10"
            >
              <button 
